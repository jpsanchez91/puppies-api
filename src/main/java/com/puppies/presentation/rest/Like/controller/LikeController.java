...
public class LikeController {
    ...
    public UUID createLike(@RequestBody CreateLikeDTO createLikeDTO, @AuthenticationPrincipal String userId) {
        return likeService.createLike(createLikeDTO, userId);
    }
}
